        ...
        <div className="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-20">
          <div className="text-center text-white">
            <div className="inline-flex items-center space-x-2 bg-white/20 backdrop-blur-sm rounded-full px-4 py-2 mb-6">
              ...
              <span className="text-sm font-medium">Join the food sharing revolution</span>
            </div>
            ...
            <p className="text-xl md:text-2xl mb-8 opacity-90 max-w-3xl mx-auto">
              Share surplus food, reduce waste, help your community thrive together
            </p>
            ...
            <div className="flex flex-col sm:flex-row justify-center items-center gap-4 mb-12">
              ...
              >
                <a href="/browse" className="flex items-center justify-center">
              ...
              >
                <a href="/add-item" className="flex items-center justify-center">
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-8 max-w-3xl mx-auto">
              <div className="flex flex-col items-center space-y-2 bg-white/10 backdrop-blur-sm rounded-xl p-6">
                ...
                <span className="text-sm opacity-90">Active Donors</span>
              </div>
              <div className="flex flex-col items-center space-y-2 bg-white/10 backdrop-blur-sm rounded-xl p-6">
                <Leaf className="w-8 h-8 text-green-200" />
                <span className="text-2xl font-bold">{mockFoodItems.length}+</span>
                <span className="text-sm opacity-90">Items Shared</span>
              </div>
              <div className="flex flex-col items-center space-y-2 bg-white/10 backdrop-blur-sm rounded-xl p-6">
                <Star className="w-8 h-8 text-yellow-200" />
                <span className="text-2xl font-bold">4.9</span>
                <span className="text-sm opacity-90">Community Rating</span>
              </div>
            </div>
          </div>
        </div>
